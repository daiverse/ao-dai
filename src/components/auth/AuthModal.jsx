    ...
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fadeIn">
        <div className="relative w-full max-w-sm bg-white rounded-3xl p-8 shadow-2xl text-center space-y-4 border border-emerald-100 animate-scaleUp">
          ...
          <div className="inline-flex items-center gap-1.5 text-xs text-[#E43D12] font-semibold bg-amber-50 px-3 py-1.5 rounded-full border border-amber-200/60 animate-pulse">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 transition-all">
        ...
        {/* Header Banner */}
        <div className="bg-[#EFB11D] p-7 text-center relative border-b border-amber-600/20">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#7A0C00]/10 backdrop-blur-xs text-[#7A0C00] text-[11px] font-extrabold uppercase tracking-wider mb-2 border border-[#7A0C00]/25">
            <Sparkles className="w-3.5 h-3.5 text-[#7A0C00]" /> DaiVerse Account
          </div>
          ...
          {view === "login" && (
            <form onSubmit={handleLoginSubmit} className="space-y-4">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-[#EBE9E1] border border-gray-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#E43D12] focus:bg-white transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-[#E43D12] hover:underline bg-transparent border-none cursor-pointer p-0"
                  >
                    Quên mật khẩu?
                  </button>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-11 py-3 bg-[#EBE9E1] border border-gray-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#E43D12] focus:bg-white transition-all"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#E43D12] hover:bg-[#E43D12]/90 text-white font-bold text-sm rounded-2xl transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50"
              >
                {loading ? (
              ...
              <p className="text-center text-xs text-gray-500 pt-2">
                ...
                <button
                  ...
                  className="font-bold text-[#EFB11D] hover:underline bg-transparent border-none cursor-pointer p-0"
                >
                  Đăng ký ngay
                </button>
              </p>
          ...
          {view === "register" && (
            <form onSubmit={handleSendOTPSubmit} className="space-y-3.5">
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-[#EBE9E1] border border-gray-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#E43D12] focus:bg-white transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={password}
                    onChange={(e) => setPassword(e.target.value)}
                    className="w-full pl-10 pr-11 py-2.5 bg-[#EBE9E1] border border-gray-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#E43D12] focus:bg-white transition-all"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#EFB11D] hover:bg-[#EFB11D]/90 text-white font-bold text-sm rounded-2xl transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50 mt-2"
              >
                {loading ? (
                  <RefreshCw className="w-4 h-4 animate-spin" />
                ) : (
              ...
              <p className="text-center text-xs text-gray-500 pt-2">
                ...
                <button
                  ...
                  className="font-bold text-[#E43D12] hover:underline bg-transparent border-none cursor-pointer p-0"
                >
                  Đăng nhập
                </button>
              </p>
              ...
              <div className="flex justify-between gap-2 my-4">
                {otp.map((data, index) => (
                  <input
                    ...
                    type="text"
                    maxLength="1"
                    className="otp-input w-12 h-14 text-center font-bold text-xl bg-[#EBE9E1] border-2 border-gray-200 rounded-2xl focus:border-[#E43D12] focus:bg-white focus:outline-none transition-all"
                    value={data}
              ...
              <div className="text-center space-y-2 text-xs">
                <p className="text-gray-500">
                  ...
                  <button
                    ...
                    className={`font-bold text-[#EFB11D] bg-transparent border-none p-0 ${
          ...
          {view === "forgot" && (
            <form onSubmit={handleForgotSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#EFB11D] hover:bg-[#EFB11D]/90 text-white font-bold text-sm rounded-2xl transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50"
              >
                {loading ? (
                  <RefreshCw className="w-4 h-4 animate-spin" />
                ) : (
