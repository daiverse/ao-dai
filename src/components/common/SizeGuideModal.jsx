  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100 max-h-[90vh] flex flex-col">
        ...
        {/* Header */}
        <div className="bg-gradient-to-r from-[#C5A059] to-[#C8A800] p-6 text-white text-center shrink-0">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-[#C5A059] text-[11px] font-bold uppercase tracking-wider mb-2 border border-white/10">
          ...
          <div className="flex items-center justify-center gap-2 mt-5">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-bold transition-all border cursor-pointer flex items-center gap-1 ${
                activeTab === "custom"
                  ? "bg-[#C5A059] text-[#C5A059] border-[#C5A059] shadow-md"
                  : "bg-white/10 text-white/80 border-white/10 hover:bg-white/20"
              }`}
            >
            ...
            <div className="space-y-4">
              <div className="overflow-x-auto rounded-2xl border border-gray-200">
                <table className="w-full text-center text-xs">
                  <thead>
                    <tr className="bg-[#C5A059] text-white font-bold uppercase tracking-wider text-[11px]">
                  ...
                  <tbody className="divide-y divide-gray-100 font-medium text-gray-700">
                    {sizeData.map((item, idx) => (
                      ...
                      >
                        <td className="py-3 px-2 font-bold text-[#C5A059] text-sm">{item.size}</td>
                        ...
                        <td className="py-3 px-2 font-semibold text-[#C5A059]">{item.waist} cm</td>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-white rounded-2xl border border-gray-200 space-y-2 shadow-xs">
                  <span className="w-6 h-6 rounded-full bg-[#C5A059] text-white font-bold text-xs flex items-center justify-center">1</span>
                ...
                <div className="p-4 bg-white rounded-2xl border border-gray-200 space-y-2 shadow-xs">
                  <span className="w-6 h-6 rounded-full bg-[#C5A059] text-white font-bold text-xs flex items-center justify-center">2</span>
                ...
                <div className="p-4 bg-white rounded-2xl border border-gray-200 space-y-2 shadow-xs">
                  <span className="w-6 h-6 rounded-full bg-[#C5A059] text-white font-bold text-xs flex items-center justify-center">3</span>
                ...
                <div className="p-4 bg-white rounded-2xl border border-gray-200 space-y-2 shadow-xs">
                  <span className="w-6 h-6 rounded-full bg-[#C5A059] text-white font-bold text-xs flex items-center justify-center">4</span>
            ...
            <form onSubmit={handleSaveCustomMeasurements} className="space-y-4">
              {isSaved ? (
                ...
                <>
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-[#EBE9E1] border border-gray-200 rounded-xl text-xs font-semibold focus:outline-none focus:border-[#C5A059]"
                      />
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 bg-[#EBE9E1] border border-gray-200 rounded-xl text-xs font-medium focus:outline-none focus:border-[#C5A059]"
                      />
                    </div>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 bg-[#C5A059] hover:bg-[#C5A059]/90 text-white font-bold text-xs rounded-xl shadow-md transition-all cursor-pointer border-none"
                  >
