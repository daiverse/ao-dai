...
export default function HeroBanner({ onNavigate }) {
  return (
    <section className="relative min-h-screen flex flex-col lg:block overflow-hidden bg-white pb-16 lg:pb-20 pt-32 sm:pt-40 lg:pt-36">
      ...
      <div className="absolute top-36 left-[10%] lg:left-[12%] w-2.5 h-2.5 bg-[#C85A32] rounded-full hidden sm:block z-[2] animate-pulse"></div>
      <div className="absolute top-52 left-[13%] lg:left-[15%] w-1.5 h-1.5 bg-[#C85A32]/60 rounded-full hidden sm:block z-[2]"></div>
      ...
      <div className="container-page relative z-[2] flex-1 lg:flex lg:items-start lg:min-h-[calc(100vh-8rem)] pt-2 lg:pt-6">
        <div className="max-w-2xl pt-2 lg:pt-4">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold text-gray-900 mb-5 lg:mb-6 leading-[1.15]">
            Áo dài<br />
            <span className="text-[#18392B] italic font-heading font-semibold">thanh nhã</span> cho<br />
            phong cách riêng
          </h1>

          <p className="text-base sm:text-lg text-gray-600 mb-8 lg:mb-10 max-w-md leading-[1.7]">
            Khám phá những thiết kế áo dài độc đáo, được may đo thủ công từ nghệ nhân hàng đầu phối hợp cùng trí tuệ nhân tạo AI Studio.
          </p>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            <button
              ...
              className="group inline-flex items-center gap-3 px-7 sm:px-8 py-3.5 sm:py-4 bg-[#18392B] text-white font-medium rounded-full hover:bg-[#18392B]/90 transition-all shadow-xl shadow-[#18392B]/20 cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 px-6 sm:px-7 py-3.5 sm:py-4 border-2 border-[#C85A32]/60 text-[#18392B] font-semibold rounded-full hover:bg-[#C85A32] hover:text-white hover:border-[#C85A32] transition-all cursor-pointer bg-white/80 backdrop-blur-xs"
            >
              <Palette className="w-4 h-4 text-[#C85A32] group-hover:text-white" />
