...
export default function HeroBanner({ onNavigate }) {
  return (
    <section className="relative min-h-screen flex flex-col lg:block overflow-hidden bg-white pb-16 lg:pb-20 pt-32 sm:pt-40 lg:pt-36">
      ...
      <div className="absolute top-36 left-[10%] lg:left-[12%] w-2.5 h-2.5 bg-[#E43D12] rounded-full hidden sm:block z-[2] animate-pulse"></div>
      <div className="absolute top-52 left-[13%] lg:left-[15%] w-1.5 h-1.5 bg-[#E43D12]/60 rounded-full hidden sm:block z-[2]"></div>
      <div className="absolute bottom-36 left-[8%] lg:left-[10%] w-3 h-3 border-2 border-[#E43D12]/40 rounded-full hidden lg:block z-[2]"></div>
      ...
      <div className="container-page relative z-[2] flex-1 lg:flex lg:items-start lg:min-h-[calc(100vh-8rem)] pt-2 lg:pt-6">
        <div className="max-w-2xl pt-2 lg:pt-4">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-bold text-gray-900 mb-5 lg:mb-6 leading-[1.15]">
            Áo dài<br />
            <span className="text-[#E43D12] italic font-heading font-semibold">DaiVerse</span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4">
            <button
              ...
              className="group inline-flex items-center gap-3 px-7 sm:px-8 py-3.5 sm:py-4 bg-[#EFB11D] text-white font-medium rounded-full hover:bg-[#EFB11D]/90 transition-all shadow-xl shadow-[#EFB11D]/20 cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2.5 px-6 sm:px-7 py-3.5 sm:py-4 border-2 border-[#E43D12]/60 text-[#EFB11D] font-semibold rounded-full hover:bg-[#E43D12] hover:text-white hover:border-[#E43D12] transition-all cursor-pointer bg-white/80 backdrop-blur-xs"
            >
              <Palette className="w-4 h-4 text-[#E43D12] group-hover:text-white" />
            ...
            {FEATURE_FLAGS.ENABLE_AI_TRY_ON && (
              <button
                ...
                className="inline-flex items-center gap-2.5 px-6 sm:px-7 py-3.5 sm:py-4 border-2 border-[#EFB11D] text-[#EFB11D] font-semibold rounded-full hover:bg-[#EFB11D] hover:text-white transition-all cursor-pointer bg-white/80 backdrop-blur-xs"
              >
          ...
          <div className="mt-12 lg:mt-16 flex gap-8 sm:gap-12 border-t border-gray-100 pt-8">
            <div>
              <div className="text-3xl sm:text-4xl font-bold mb-1 font-heading text-[#EFB11D]">5+</div>
              <div className="text-xs sm:text-sm text-gray-500 font-medium">Mẫu áo dài</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold mb-1 font-heading text-[#EFB11D]">100+</div>
              <div className="text-xs sm:text-sm text-gray-500 font-medium">Hàng trăm khách hàng</div>
            </div>
            <div>
              <div className="text-3xl sm:text-4xl font-bold mb-1 font-heading text-[#E43D12]">4.9 ★</div>
