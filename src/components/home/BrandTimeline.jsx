...
export default function BrandTimeline() {
  ...
  return (
    <section className="py-24 lg:py-32 bg-[#FBF9F5] relative overflow-hidden">
      <div className="container-page">
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16 lg:mb-20">
          <p className="text-xs uppercase tracking-[0.35em] text-[#C85A32] font-bold mb-4">
            Hành Trình
          </p>
          <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-[#18392B] leading-[1.1]">
            Mỗi tà áo đều bắt đầu <em className="italic font-heading text-[#C85A32] font-semibold">từ một câu chuyện</em>
          </h2>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <div className="hidden lg:block absolute top-0 bottom-0 left-1/2 -translate-x-1/2 w-px bg-gradient-to-b from-[#C85A32]/30 via-[#C85A32]/15 to-transparent"></div>

          {/* Left vertical line (mobile) */}
          <div className="lg:hidden absolute top-0 bottom-0 left-4 w-px bg-gradient-to-b from-[#C85A32]/30 via-[#C85A32]/15 to-transparent"></div>
                ...
                <div key={index} className="relative">
                  ...
                  <div className="absolute left-4 lg:left-1/2 -translate-x-1/2 -top-2 z-10">
                    <div className="flex flex-col items-center">
                      <span className="px-3 py-1 bg-[#18392B] text-white text-[10px] uppercase tracking-[0.2em] font-bold rounded-full shadow-lg">
                        {item.year}
                      </span>
                      <div className="w-px h-4 bg-[#18392B]/30 mt-1"></div>
                    </div>
                  </div>
                  ...
                  <div className="pt-10 lg:pt-8">
                    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start pl-12 lg:pl-0`}>
                      ...
                      >
                        <h3 className="font-heading text-2xl sm:text-3xl font-bold text-[#18392B]">
                          {item.title}
                        </h3>
                      ...
                      >
                        {item.image ? (
                          ...
                          <div className="rounded-2xl bg-[#18392B]/5 border border-[#18392B]/10 p-8 flex items-center justify-center aspect-[4/3]">
                            <div className="text-center space-y-3">
                              <span className="text-5xl">🌸</span>
                              <p className="text-sm text-[#18392B]/60 font-medium italic">
