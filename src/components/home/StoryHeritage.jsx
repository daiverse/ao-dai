        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute top-8 left-8 p-4 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl border border-gray-100 max-w-[200px]">
              <p className="font-heading font-bold text-2xl text-[#18392B]">20+ Năm</p>
          ...
          <div className="space-y-8 lg:pl-6">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#C85A32] font-bold mb-3">
                Hành Trình Di Sản
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {highlights.map((item, index) => (
                <div key={index} className="p-4 rounded-2xl bg-[#FBF9F5] border border-gray-100 space-y-2">
            ...
            <div className="pt-4">
              <button
                ...
                className="px-8 py-3.5 bg-[#18392B] text-white rounded-full font-semibold hover:bg-[#18392B]/90 shadow-lg shadow-[#18392B]/20 transition-all cursor-pointer text-sm"
              >
