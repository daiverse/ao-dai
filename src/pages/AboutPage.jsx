...
function StoryDetail({ product, onBack }) {
  ...
  return (
    <div className="pt-28 sm:pt-32 pb-24 bg-[#FBF9F5] min-h-screen">
      <div className="container-page max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between gap-4 mb-8 pt-4">
          ...
          <div className="text-xs text-gray-500 font-medium hidden sm:block">
            ...
            <span className="text-[#C85A32] font-semibold">{product.name}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start mb-16">
          ...
          <div className="space-y-4 sticky top-28">
            ...
            <div className="relative aspect-[3/4] rounded-3xl overflow-hidden bg-gray-100 shadow-2xl border border-gray-100 group">
              ...
              <div className="absolute top-4 left-4">
                <span className="text-[11px] font-bold uppercase tracking-widest bg-[#18392B]/90 backdrop-blur-md text-[#D4A373] px-3.5 py-1.5 rounded-full border border-white/10">
              ...
              {product.images.map((img, idx) => (
                <button
                  ...
                  className={`aspect-[3/4] rounded-xl overflow-hidden border-2 transition-all cursor-pointer p-0 ${
                    activeImg === idx
                      ? "border-[#18392B] shadow-lg scale-105"
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-wrap gap-2">
              <span className="text-[11px] font-bold uppercase tracking-widest text-[#C85A32] bg-[#C85A32]/10 border border-[#C85A32]/20 px-4 py-1.5 rounded-full">
                {product.fabric}
              </span>
            ...
            <div className="flex items-center gap-4">
              <div className="h-px flex-1 bg-[#C85A32]/30"></div>
              <span className="text-[#C85A32] text-lg">✦</span>
              <div className="h-px flex-1 bg-[#C85A32]/30"></div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
              <h3 className="font-heading font-bold text-[#18392B] text-sm uppercase tracking-wider">
                Chi Tiết Thiết Kế
              </h3>
              <div className="grid grid-cols-1 gap-3 text-sm">
                <div className="flex items-start gap-3">
                  <span className="text-[#C85A32] font-bold text-xs uppercase tracking-wide w-20 shrink-0 pt-0.5">Chất liệu</span>
                  <span className="text-gray-700 font-medium">{product.fabric}</span>
                </div>
                <div className="flex items-start gap-3">
                  <span className="text-[#C85A32] font-bold text-xs uppercase tracking-wide w-20 shrink-0 pt-0.5">Sizes</span>
                  <span className="text-gray-700">{product.sizes?.join(" · ")}</span>
                </div>
                {product.description && (
                  <div className="flex items-start gap-3">
                    <span className="text-[#C85A32] font-bold text-xs uppercase tracking-wide w-20 shrink-0 pt-0.5">Mô tả</span>
            ...
            {/* Price & CTA */}
            <div className="bg-[#18392B] rounded-2xl p-6 text-white space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <span className="text-[#D4A373] text-xs uppercase tracking-wider font-bold block mb-1">Giá tham khảo</span>
              ...
              <button className="w-full py-3.5 bg-[#C85A32] hover:bg-[#C85A32]/90 text-white font-bold text-sm rounded-xl transition-all cursor-pointer border-none flex items-center justify-center gap-2">
        ...
        {product.images.length > 2 && (
          <section className="mb-16">
            <div className="text-center mb-8">
              <span className="text-xs uppercase tracking-[0.3em] text-[#C85A32] font-bold">Bộ Sưu Tập Ảnh</span>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {product.images.map((img, idx) => (
                <div
                  key={idx}
                  onClick={() => setActiveImg(idx)}
                  className={`aspect-[3/4] rounded-2xl overflow-hidden cursor-pointer shadow-md hover:shadow-xl transition-all hover:-translate-y-1 border-2 ${activeImg === idx ? "border-[#C85A32]" : "border-transparent"}`}
                >
...
export default function AboutPage() {
  ...
  const commitments = [
    { icon: <ShieldCheck className="w-6 h-6 text-[#C85A32]" />, title: "Chất Liệu Thượng Hạng", desc: "Cam kết lụa gấm trúc, gấm tơ mềm & tơ tằm ánh kim 100% chuẩn di sản." },
    { icon: <Clock className="w-6 h-6 text-[#C85A32]" />, title: "May Sẵn & Giao 24h", desc: "Đội ngũ sẵn size S, M, L giao hỏa tốc 24h và hỗ trợ may đo cá nhân." },
    { icon: <Scissors className="w-6 h-6 text-[#C85A32]" />, title: "Phom Dáng Vừa Vặn", desc: "Tỉ lệ đường may tôn vinh đường cong thanh thoát tự nhiên của phụ nữ Việt." },
    { icon: <Award className="w-6 h-6 text-[#C85A32]" />, title: "Trải Nghiệm AI Trực Quan", desc: "Xem trước sản phẩm trên ảnh cá nhân trước khi quyết định may sở hữu." }
  ];
  ...
  return (
    <div className="pt-32 sm:pt-36 lg:pt-32 pb-24 bg-[#FBF9F5] min-h-screen text-gray-900">
      ...
      <section className="container-page mb-16 lg:mb-20">
        <div className="text-center max-w-4xl mx-auto space-y-4">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-[1.18]">
            ...
            <span className="text-[#18392B] italic font-heading font-semibold">Giao Thoa Di Sản Truyền Thống & AI Đương Đại</span>
          </h1>
      ...
      <section className="container-page space-y-24 mb-24">
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-12 border border-gray-200/80 shadow-xl space-y-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border-b border-gray-100 pb-8">
            <div className="lg:col-span-8 space-y-3">
              <span className="text-xs uppercase tracking-[0.3em] text-[#C85A32] font-bold block">Bộ Sưu Tập 01</span>
              <h2 className="font-heading text-3xl sm:text-4xl font-bold text-[#18392B]">
            ...
            <div className="lg:col-span-4 flex lg:justify-end">
              <div className="px-5 py-2.5 bg-[#18392B]/10 text-[#18392B] rounded-full text-xs font-bold uppercase tracking-wider">
                ✦ 4 Thiết Kế Độc Bản
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {mocLanProducts.map(product => (
              <article
                ...
                className="group space-y-3 bg-[#FBF9F5] p-5 rounded-2xl border border-gray-100 hover:border-[#C85A32]/40 hover:shadow-xl transition-all duration-400 cursor-pointer hover:-translate-y-1"
              >
                <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-gray-200">
                  ...
                  <div className="absolute bottom-3 left-0 right-0 flex justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-400 translate-y-2 group-hover:translate-y-0">
                    <span className="text-xs font-bold text-white bg-[#C85A32] px-4 py-2 rounded-full shadow-lg flex items-center gap-1.5">
                      <Eye className="w-3.5 h-3.5" />
                      Xem Câu Chuyện
                    </span>
                  </div>
                </div>
                <span className="text-[11px] text-[#C85A32] font-bold uppercase tracking-wider block">{product.fabric}</span>
                <h3 className="font-heading text-lg font-bold text-gray-900 group-hover:text-[#C85A32] transition-colors">
                ...
                <div className="flex items-center justify-between pt-1 text-xs">
                  <span className="font-bold text-[#18392B]">{product.formattedPrice}</span>
                  <span className="text-[#C85A32] font-bold flex items-center gap-1 group-hover:gap-2 transition-all">
        ...
        {/* BST 2: Phong Sắc */}
        <div className="bg-gradient-to-br from-[#18392B] to-[#0F241B] text-white rounded-3xl p-8 sm:p-12 shadow-2xl space-y-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center border-b border-white/10 pb-8">
            <div className="lg:col-span-8 space-y-4">
              <span className="text-xs uppercase tracking-[0.3em] text-[#D4A373] font-bold block">Bộ Sưu Tập 02</span>
              ...
              <div className="flex items-center gap-3 text-xs text-[#D4A373] font-medium">
                <CheckCircle2 className="w-4 h-4 text-[#D4A373]" />
                <span>Chất liệu Tafta giãn ngang nhẹ cao cấp</span>
              </div>
            </div>
            <div className="lg:col-span-4 flex lg:justify-end">
              <div className="px-5 py-2.5 bg-white/10 text-[#D4A373] rounded-full text-xs font-bold uppercase tracking-wider border border-white/10">
                ✦ 1 Thiết Kế Độc Bản
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {phongSacProducts.map(product => (
              <article
                key={product.id}
                onClick={() => handleSelectProduct(product)}
                className="group bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl overflow-hidden hover:bg-white/15 hover:border-[#D4A373]/50 hover:shadow-2xl transition-all duration-400 cursor-pointer hover:-translate-y-1"
              >
                ...
                <div className="p-5 space-y-2">
                  <span className="text-[11px] text-[#D4A373] font-bold uppercase tracking-wider block">{product.fabric}</span>
                  <h3 className="font-heading text-lg font-bold text-white group-hover:text-[#D4A373] transition-colors">
                    {product.storyTitle.split('|')[0].trim()}
                  </h3>
                  ...
                  <div className="flex items-center justify-between pt-2 text-xs">
                    <span className="font-bold text-[#D4A373]">{product.formattedPrice}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {commitments.map((cm, idx) => (
            <div key={idx} className="p-6 rounded-3xl bg-white border border-gray-100 shadow-lg space-y-3">
              <div className="p-3 w-fit rounded-2xl bg-[#C85A32]/10">{cm.icon}</div>
