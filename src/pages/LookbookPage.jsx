    ...
    >
      ...
      <div className="relative w-full aspect-[3/4] bg-[#F7F4EE] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex items-center justify-between z-10">
          <span className="text-[11px] uppercase tracking-[0.2em] text-[#D4A373] font-bold bg-[#18392B]/90 backdrop-blur-md px-3.5 py-1.5 rounded-full border border-white/10 shadow-md">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="p-2 rounded-full bg-white text-gray-900 shadow-md opacity-0 group-hover:opacity-100 transition-all duration-300">
              <Eye className="w-4 h-4 text-[#18392B]" />
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none">
          <span className="px-5 py-2.5 bg-white/90 backdrop-blur-md text-[#18392B] text-xs font-bold rounded-full shadow-xl flex items-center gap-2 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
      ...
      <div className="p-6 sm:p-7 bg-white flex-1 flex flex-col justify-between space-y-3">
        <div className="space-y-2">
          ...
          <h3 className="font-heading text-2xl font-bold text-gray-900 leading-snug group-hover:text-[#C85A32] transition-colors">
            {item.title}
          </h3>
        ...
        <div className="pt-3 flex items-center justify-between border-t border-gray-100 text-xs">
          <span className="font-bold text-[#18392B] text-base">{item.formattedPrice}</span>
          <span className="text-[#C85A32] font-bold group-hover:translate-x-1 transition-transform flex items-center gap-1.5">
    ...
    <div className="pt-28 pb-20 bg-[#FBF9F5] min-h-screen">
      <div className="container-page">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-3">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#18392B]/10 text-[#18392B] text-xs font-bold uppercase tracking-[0.25em]">
          ...
          <h1 className="font-heading text-4xl sm:text-5xl font-bold text-gray-900 leading-tight">
            Lookbook High-Fashion <span className="font-heading italic text-[#C85A32]">DaiVerse</span>
          </h1>
        ...
        <div className="flex flex-wrap justify-center items-center gap-3 mb-14">
          <button
            ...
            className={`px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border-none outline-none ${
              activeFilter === "all"
                ? "bg-[#18392B] text-white shadow-xl shadow-[#18392B]/20 scale-105"
          ...
          <div className="my-16 rounded-3xl overflow-hidden shadow-2xl relative bg-[#18392B] text-white">
            <div className="grid grid-cols-1 lg:grid-cols-12 items-center">
              <div className="lg:col-span-6 h-[320px] sm:h-[380px] lg:h-[420px] relative overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-[#18392B]/30 to-[#18392B] hidden lg:block"></div>
              ...
              <div className="lg:col-span-6 p-8 sm:p-10 lg:p-12 space-y-4">
                ...
                <div className="pt-3 flex flex-wrap items-center gap-3">
                  <button
                    ...
                    className="px-6 py-3 bg-[#C85A32] text-white rounded-full text-xs font-bold hover:bg-[#C85A32]/90 shadow-md cursor-pointer border-none"
                  >
