...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="pt-36 pb-24 min-h-screen bg-[#EBE9E1] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-14 h-14 bg-[#EFB11D]/10 text-[#EFB11D] rounded-2xl flex items-center justify-center mx-auto mb-2">
