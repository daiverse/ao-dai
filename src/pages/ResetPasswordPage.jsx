...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="pt-36 pb-24 min-h-screen bg-[#FAF6F0] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#FAF6F0] rounded-3xl shadow-2xl border border-neutral-300 p-8 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-14 h-14 bg-[#C5A059]/10 text-[#C5A059] rounded-2xl flex items-center justify-center mx-auto mb-2">
        ...
        {error && (
          <div className="p-3.5 text-xs text-[#C5A059] bg-rose-50 border border-rose-200 rounded-2xl">
            ⚠️ {error}
          </div>
        )}
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-3 bg-white border border-gray-200 rounded-2xl text-sm font-medium focus:outline-none focus:border-[#C5A059] focus:bg-white transition-all"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-[#C5A059] hover:bg-[#A4813D] text-white font-bold text-sm rounded-2xl transition-all shadow-lg flex items-center justify-center gap-2 cursor-pointer border-none disabled:opacity-50"
            >
              {loading ? (
